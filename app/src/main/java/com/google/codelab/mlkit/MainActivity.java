...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedImage = BitmapFactory.decodeResource(getResources(), R.id.image_view, options);
    ...
    private void processTextRecognitionResult(Text texts) {
        ...
        for (int i = 0; i < blocks.size(); i++) {
            Log.v(TAG, blocks.get(i).getText());
            msg += blocks.get(i).getText()+"\n";
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                Log.v(TAG,"Error in creating file "+ex.getMessage());
            }
            // Continue only if the File was successfully created
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.google.codelab.mlkit.fileprovider",
                        photoFile);
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                mSelectedImage = getBitmapFromAsset(this, "test.jpeg");
                break;
            case 1:
